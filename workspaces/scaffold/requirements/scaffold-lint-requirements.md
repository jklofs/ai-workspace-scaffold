...
|-----------|--------|---------|--------|
| SCAFFOLD-TICKET-001 | ../raw-input/scaffold-lint-request.md | Add a scaffold health-check script | Closed |

## Functional Requirements

| ID | Requirement |
|----|-------------|
| SCAFFOLD-REQ-001 | The script shall verify required root files exist. |
| SCAFFOLD-REQ-002 | The script shall verify required root directories exist. |
| SCAFFOLD-REQ-003 | The script shall verify each workspace has a root `README.md`. |
| SCAFFOLD-REQ-004 | The script shall verify each standard phase directory inside a workspace has a `README.md`. |
| SCAFFOLD-REQ-005 | The script shall verify non-index wiki pages are listed in `wiki/index.md`. |
| SCAFFOLD-REQ-006 | The script shall run `git diff --check` and report formatting issues. |
...
|----------------|-----------|--------|-------|
| SCAFFOLD-REQ-001 | SCAFFOLD-TICKET-001 | ../raw-input/scaffold-lint-request.md | Health-check command |
| SCAFFOLD-REQ-004 | SCAFFOLD-TICKET-001 | ../../WIKI-SCHEMA.md | Workspace phase README checks |
| SCAFFOLD-REQ-005 | SCAFFOLD-TICKET-001 | ../../wiki/workflow/llm-wiki-operations.md | Wiki index coverage |
