...
- [x] wiki/scaffold/scaffold.md — Scaffold maintenance work should use this workspace when changing schema, templates, scripts, wiki operations, or workspace structure.
